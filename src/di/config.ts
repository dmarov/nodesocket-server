...
container.bind<SocketServer>(TYPES.SocketServer).to(MessageSocketServer);
container.bind<SocketHandler>(TYPES.SocketHandler).to(MessageSocketHandler);
container.bind<PlainDb>(TYPES.PlainDb).to(RamDb).inSingletonScope();
